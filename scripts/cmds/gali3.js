module.exports = {
  config: {
    ...
    aliases: ["chud"],
    version: "1.0",
    author: "nexo_here edit by Milon",
    role: 2,
    category: "admin",
    guide: {
      vi: "Not Available",
...
setTimeout(() => {a({body: "কিরে মাদারচোত মিলন এর চুদন খাওয়ায় জন্য রেডি তো?" + "লে চুদা খা মাঙ্গের বেটা 😂😂" + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "মাগি চুদা শোরের বাচ্চা কার লগে পাঙ্গা নিতে আসছিস 🤬🤬🤬" + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: " চুদে গুয়া ফাঁক করে দিব খানকীর পোলা 🤤" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: " মাদারচোদ বোকাচোদা খানকীর পোলা " + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: " বেশ্যা মাগি চোদা কুত্তা চোদা" + " " + name, mentions: arraytag})}, 12000);
...
setTimeout(() => {a({body: " হোল কাটে নিবো মাঙ্গের বেটা কার লগে লাগতে আসছিস 🤬" + " " + name, mentions: arraytag})} , 84000);
